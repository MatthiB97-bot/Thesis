...
def start(update, context):
    ...
    update.message.reply_text('Hi! Welcome to DMN chatbot, what kind of customer are you? (Business, Private, Government)')
...
def handle_message(update, context):
    if update.message.text in str([i for i in range(1000)]):
        cijfer = str(update.message.text)
        response = R.integer_responses(cijfer)
